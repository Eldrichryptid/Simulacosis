...
@type struct<iconMarkersSt>
@desc Setup the marker for this vehicle.
@default {"iconIndex":"165","hue":"0","scale":"0.5","syncTransparency":"true","syncDirection":"false","blinkDuration":"1","minOpacity":"255"}
...
class Sprite_MinimapMarker extends Sprite{
    ...
    buildIconBitmap(iconIndex){
        ...
        iconImage.addLoadListener(() => {
            ...
            const sw = iconImage.width
            const sh = iconImage.height
...
Eli.Minimap = {
    ...
    initParameters(){
        const rawParams = PluginManager.parameters("EliMZ_Minimap")
