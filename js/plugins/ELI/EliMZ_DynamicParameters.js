...
@plugindesc ♦5.0.1♦ Dynamic add parameters to equipments and states.
...
const pluginName = "Eli Dynamic Parameters"
...
Eli.DynamicParameters = {
    ...
    setBaseDynamicParams(data){
        ...
        if(this.dataHasDynamicParams(data)){
    ...
    setMetaDynamicParams(data){
        ...
        const preset = this.param().preset.find(item => dynParamTag === Eli.String.removeSpaces(item.name))
