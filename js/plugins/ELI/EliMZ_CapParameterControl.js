...
@plugindesc ♦5.0.1♦ Manage how the actor can exceed the cap value.
...
Eli.CapParameterControl = {
    ...
    initParameters(){
        const parameters = PluginManager.parameters("EliMZ_CapParameterControl")
